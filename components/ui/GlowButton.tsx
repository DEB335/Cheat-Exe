 ...
 * the effect is built out of four stacked spans.
 */
export function GlowButton({
  ...
  return (
    ...
    >
      {/* Blurred colour mesh drifting behind the pill */}
      <span className="absolute inset-0 overflow-hidden rounded-full">
        <span className="pointer-events-none absolute inset-0 select-none">
          <span
            className="block size-24 rounded-full blur-[20px]"
            style={{ background: MESH, transform: "translate(-50%, -33.33%)" }}
          />
        </span>
      </span>

      {/* Travelling highlight along the border */}
      <span className="animate-border-glow-translate pointer-events-none absolute inset-0 select-none">
        <span
          className="animate-border-glow-scale block h-full w-12 -translate-x-1/2 rounded-full blur-[20px]"
      ...
      >
        <span
          className={cn(
            "relative inline-flex items-center justify-center transition-transform duration-500",
  ...
  return (
    ...
    >
      <path
        ...
        fill="url(#glow-star-fill)"
        stroke="url(#glow-star-stroke)"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <defs>
        <linearGradient id="glow-star-fill" x1="-0.5" y1="9" x2="15.5" y2="-1.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#7A69F9" />
          <stop offset="0.575" stopColor="#F26378" />
          <stop offset="1" stopColor="#F5833F" />
        </linearGradient>
        <linearGradient id="glow-star-stroke" x1="-0.5" y1="9" x2="15.5" y2="-1.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#7A69F9" />
          <stop offset="0.575" stopColor="#F26378" />
          <stop offset="1" stopColor="#F5833F" />
        </linearGradient>
